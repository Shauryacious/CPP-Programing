...
// x =                A 0s and 1s then ek 1 then B 0s
// x' = ~x =          A 1s and 0s then ek 0 then B 1s
// x" = ~x + 1 =      A 1s and 0s then ek 1 then B 0s
                  // ---------------------------------
// x & x" =           A 0s and 0s then ek 1 then B 0s   <----- this is the RSB we wanted
